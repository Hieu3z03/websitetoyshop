...
<!--                                <td>
                                ...
                                <td>${o.price} $</td>
                                <td><fmt:formatNumber pattern="##" value="${o.p_quantity}"/></td>
                                <td>
                    ...
                    <form action="add" method="post">
                        ...
                        <div class="modal-body">					
                            ...
                            <div class="form-group">
                                ...
                                <input name="p_quantity" type="number" class="form-control" required >
                                <c:if test="${not empty requestScope.qError}">
                                    <div style="color: red;">${requestScope.qError}</div>
                                </c:if>
                            </div>
                            <div class="form-group">
